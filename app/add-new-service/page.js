        ...
        <div className="container">
          <div className="row">
            <div className="login-main add-list add-ncate">
              ...
              <span className="udb-inst">New Listing Service</span>
              <div className="log log-1">
                <div className="login">
                  ...
                  <form name="category_form" id="category_form" method="post" action="insert_category.html" className="cre-dup-form cre-dup-form-show" encType="multipart/form-data">
                    <ul>
                      <li>
                        <div className="row">
                          <div className="col-md-12">
                            <div className="form-group">
                              <input type="text" id="category_name" name="service_name" className="form-control" placeholder="Service name *" required />
                            </div>
                          </div>
                          <div className="col-md-12">
                            <div className="form-group">
                  ...
                  <div className="col-md-12">
                    <a href="admin-all-category.html" className="skip">Go to All Listing Category &gt;&gt;</a>
                  </div>
                </div>
              </div>
            </div>
