...
mutation CreateJob($data: TaskData!) {
  createJob(data: $data) {
    code
    success
    message
...
export const ASSIGN_TASK_TO_EMP = gql`
mutation AssignTask($employee: ID!, $task: ID!) {
  assignTask(employee: $employee, task: $task) {
    code
    message
  }
}
