...
const Header = ({ transparent }) => {
  ...
  return (
    <>
      <div
        className={`${
          scrollPosition > 0 || transparent === false
            ? "hom-top dmact"
            : "hom-top"
        }`}
      >
        <div className="container">
          <div className="row">
            <div className="hom-nav  db-open ">
              ...
              <DbMenu
                session={session}
                setDashboardVisiblity={setDashboardVisiblity}
                dashboardvisiblity={dashboardvisiblity}
              />
              <ul className={`bl ${session ? "hidden" : "block"}`}>
                <li>
                  <Link href="https://bizbookdirectorytemplate.com/pricing-details">
                    Add business
                  </Link>
                </li>
                <li>
              ...
              <MobileMenu
                session={session}
                setMobMenuVisibility={setMobMenuVisibility}
