    ...
    <div className="head-s2">
      <div className="head-sear">
        ...
        <ul id="tser-res" className="tser-res">
          ...
          <li>
            <a href="admin-text-changes.html">How to change all static texts</a>
          </li>
          <li>
          ...
          <li>
            <a href="admin-add-new-category.html">Add new listing category</a>
          </li>
          <li>
          ...
          <li>
            <a href="admin-all-product-category.html">All product category</a>
          </li>
          <li>
          ...
          <li>
            <a href="admin-create-notification.html">Send new notifications</a>
          </li>
          <li>
          ...
          <li>
            <a href="admin-filter-features.html">Listing feature filter edit</a>
          </li>
          <li>
          ...
          <li>
            <a href="admin-price-edit.html?row=2">Edit standard pricing plan</a>
          </li>
          <li>
            <a href="admin-price-edit.html?row=3">Edit premium pricing plan</a>
          </li>
          <li>
          ...
          <li>
            <a href="seo-listing-options.html">Listing category promotions</a>
          </li>
          <li>
            <a href="seo-listing-options.html">Listing category SEO setting</a>
          </li>
          <li>
          ...
          <li>
            <a href="seo-target-promotion-all-pages.html">Target promotion</a>
          </li>
          <li>
            <a href="seo-target-promotion-all-pages.html">
          ...
          <li>
            <a href="seo-target-promotion-all-pages.html">Target listing SEO</a>
          </li>
          <li>
